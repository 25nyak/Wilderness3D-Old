...
Shader "SNB_Nature/SNB_Foliage_Deferred"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			#endif //aseld
			float dotResult187 = dot( ase_worldViewDir , -ase_worldlightDir );
			float dotResult177 = dot( pow( dotResult187 , 1.0 ) , 1.0 );
			float temp_output_162_0 = saturate( dotResult177 );
			float isPointLight174 = _WorldSpaceLightPos0.w;
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			o.Emission = ( float4( 0,0,0,0 ) + ( ( ( ( temp_output_162_0 * saturate( ( 0.0 + ( 1.0 - _DirectionalShadows ) ) ) * ( 1.0 - isPointLight174 ) ) + ( temp_output_162_0 * _PointLightTranslucency * isPointLight174 ) ) * 1.0 ) * ( tex2DNode36 * ase_lightColor * _TranslucencyForce ) ) ).rgb;
			...
			o.Smoothness = tex2D( _EmissionRMetallicGSmoothnessB, uv_EmissionRMetallicGSmoothnessB ).b;
			o.Alpha = 1;
...
/*ASEBEGIN
Version=16100
7;1109;1906;1004;5155.084;1493.946;3.223474;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;188;-2116.789,240.1963;Float;False;Property;_DirectionalShadows;Directional Shadows;6;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;131;-2752.534,1253.118;Float;False;Property;_WindTrunkSpeed;Wind Trunk Speed;11;0;Create;True;0;0;False;0;0;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2187.593,1232.33;Float;False;Property;_WindTrunkAmplitude;Wind Trunk Amplitude;10;0;Create;True;0;0;False;0;0;0.06;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-2467.55,2460.16;Float;False;Property;_WindFoliageSpeed;Wind Foliage Speed;9;0;Create;True;0;0;False;0;0;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;203;-2579.08,1863.01;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;169;-2151.307,696.2078;Float;False;Property;_PointLightTranslucency;Point Light Translucency;7;0;Create;True;0;0;False;0;1;3;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;183;-1121.379,203.2011;Float;False;Property;_TranslucencyForce;Translucency Force;5;0;Create;True;0;0;False;0;0.4;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-1616.121,2123.507;Float;False;Property;_WindFoliageAmplitude;Wind Foliage Amplitude;8;0;Create;True;0;0;False;0;0;0.05;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BC2197907D54470DED4CA57D0FE5C690D19386B2